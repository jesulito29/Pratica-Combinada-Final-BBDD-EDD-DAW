...
public class Gestion {
	...
	public static void main(String[] args) {
		...
		do {
			String baseDatos;
			baseDatos = pideLinea("A que base datos quieres conectarte:");
			comprobacion = DBManager.connect(baseDatos);
		} while (!comprobacion);
    ...
    public static boolean menuPrincipal() {
        ...
        System.out.println("11. Filtar Filas de una tabla");
        System.out.println("12. Ejecutar procedimientos almacenados");
        System.out.println("13. Cambiar de bases de datos");
        ...
        switch (opcion) {
            ...
            case 10:
            	...
            	return false;
            case 11:
            	opcionFiltrarFilasTabla();
            	return false;
            case 12:
            	opcionEjecutarProcedimientoAlmacenado();
            	return false;
            case 13:
    ...
    /**
     * Filtra las filas por la informacion que le pasemos
     */
    public static void opcionFiltrarFilasTabla()
    {
    	String tabla, campo, informacionCampo;
    	boolean resultado;
    	tabla = pideLinea("Porque tabla quieres filtrar:");
    	System.out.println("Campos:");
		System.out.println(DBManager.verCamposTabla(tabla));
		campo = pideLinea("Elige el campo: ");
		informacionCampo = pideLinea("Porque informacion quieres filtrar: ");
		    	
    	resultado = DBManager.filtrarFilasTabla(tabla, campo, informacionCampo);
    	if (!resultado)
    	{
    		System.err.println("No se ha podido filtrar");
    	}
    }
    /**
     * Elegiremos uno de los procedimientos establecidos creados y lo ejecutaremos
     */
    public static void opcionEjecutarProcedimientoAlmacenado()
    {
    	String procedimiento;
    	String mostrarClientes = "mostrarClientes";
    	String mostrarProductoFabricante = "mostrarProductoFabricante";
    	System.out.println("Lista de procedimientos:");
    	System.out.println(mostrarClientes);
    	System.out.println(mostrarProductoFabricante);
    	procedimiento = pideLinea("Que procedimiento quieres ejecutar: ");
    	
    	if (procedimiento.equals(mostrarClientes))
    	{
    		boolean resultado = DBManager.procedimientoAlmacenadoMostrarClientes();
    		if (!resultado)
    		{
				System.err.println("Debes estar en la base de datos tienda para ejecutar este procedimiento");
    		}
    	}
    	else if (procedimiento.equals(mostrarProductoFabricante))
    	{
    		String fabricante;
    		fabricante = pideLinea("De que fabricante quieres ver los productos: ");
    		boolean resultado = DBManager.procedimientoAlmacenadomostrarProductoFabricante(fabricante);
    		if (!resultado)
    		{
				System.err.println("Debes estar en la base de datos tienda para ejecutar este procedimiento");
    		}
    	...
    	{
    		System.err.println("No existe el procedimiento");
    	}
    }
